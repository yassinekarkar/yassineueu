...
class CountryController extends AbstractController
{
    ...
    /**
     * @Route("/countries", name="back-list-countries", methods={"GET"})
    ...
    /**
     * @Route("/countries/choices", name="back-list-countries-choices", methods={"GET"})
     */
    ...
    /**
     * @Route("/country/{code}", name="back-get-country", methods={"GET"})
     */
    ...
    /**
     * @Route("/country", name="back-create-country", methods={"POST"})
    ...
    /**
     * @Route("/country/{code}", name="back-set-country", methods={"PUT"})
     * @Mapping(object="App\ApiModel\Country\Country", as="Country")
     */
