 ...
 * Unit
 *
 * @ORM\Table(name="bl_unity", indexes={@ORM\Index(name="IDX_B9CFC6C6979B1AD6", columns={"company_id"})})
 * @ORM\Entity(repositoryClass="App\Repository\UnityRepository")
 */
class Unity extends \SSH\MsJwtBundle\Entity\AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="bl_unit_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
