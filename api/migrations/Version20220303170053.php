 ...
 */
final class Version20220303170053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bl_quote_product ADD quote_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE bl_quote_product ADD CONSTRAINT FK_17DF9A76DB805178 FOREIGN KEY (quote_id) REFERENCES bl_quote (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_17DF9A76DB805178 ON bl_quote_product (quote_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bl_quote_product DROP CONSTRAINT FK_17DF9A76DB805178');
        $this->addSql('DROP INDEX IDX_17DF9A76DB805178');
        $this->addSql('ALTER TABLE bl_quote_product DROP quote_id');
